...
![findmyhash](../images/2016/4/Screen Shot 2016-04-21 at 12.13.31.png)

所谓破解要么使用字典攻击法，要么采用穷举法，这两种方法都要靠运气。

* [Kali Linux：使用John the Ripper破解密码](2016-4-4-John-the-Ripper-learn.md)
...
![findmyhash](../images/2016/4/Screen Shot 2016-04-21 at 12.41.28.png)

如破解上面的MD5哈希串'098f6bcd4621d373cade4e832627b4f6'：

* [判断hash值的加密类型](2016-5-12-identifier-hash-type.md)

```shell
# findmyhash MD5 -h 098f6bcd4621d373cade4e832627b4f6
```

![findmyhash](../images/2016/4/Screenshot from 2016-04-21 09-13-40.png)

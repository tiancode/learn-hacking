...
![Kali Linux ettercap](../images/2016/4/Screenshot from 2016-04-18 21-57-41.png)

Options菜单里确保选择Promisc mode；

Sniff菜单中选择Unified sniffing：选择使用的网络接口，我使用wlan0；如果你使用有线，选择eth0；

![Kali Linux ettercap](../images/2016/4/Screenshot from 2016-04-18 22-04-44.png)

Host->Scan for hosts，扫描当前网络中的所有主机。

Host->Host list，扫描到的主机列表：

![Kali Linux ettercap](../images/2016/4/Screenshot from 2016-04-18 22-14-28.png)
...
![Kali Linux ettercap](../images/2016/4/Screenshot from 2016-04-18 22-25-05.png)

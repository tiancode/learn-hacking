...
集线器可以直接嗅探，因为所有数据的发送形式是广播（这也是集线器、交换机和路由器的区别之一）。
...
![Wireshark](../images/2016/4/Screen Shot 2016-04-18 at 18.25.28.png)
...
![ettercap](../images/2016/4/Screenshot from 2016-04-19 09-00-57.png)

## 使用Wireshark抓包

现在wifi网络中所有计算机发送的数据包都经过攻击者计算机，攻击者需要抓取这些数据包。

![Wireshark](../images/2016/4/Screenshot from 2016-04-19 09-06-38.png)
...
![Wireshark](../images/2016/4/Screenshot from 2016-04-19 09-16-16.png)

查看明文密码：

![Wireshark](../images/2016/4/Screenshot from 2016-04-19 09-21-05.png)

ettercap也可以抓包，它直接提取了明文密码：

![ettercap](../images/2016/4/Screenshot from 2016-04-19 09-27-22.png)
